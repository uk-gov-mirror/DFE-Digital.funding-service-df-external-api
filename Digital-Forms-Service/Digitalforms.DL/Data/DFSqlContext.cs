...
namespace DigitalForms.DL.Data;

public partial class DFSqlContext : DbContext
{
    public DFSqlContext()
    {
    }

    public DFSqlContext(DbContextOptions<DFSqlContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrganisationDetail>(entity =>
        {
            ...
            //entity.HasOne(d => d.UidNavigation).WithMany(p => p.OrganisationDetails).HasConstraintName("FK_OrganisationDetails.UID");
        });
